...
const Register = () => {
  ...
  <Box sx={{ maxWidth: 300, mx: 'auto', mt: 8, textAlign: 'center' }}>
    ...
    <TextField value={username} onChange={(e)=>setUsername(e.target.value)} fullWidth label="Username" sx={{ mb: 2 }} />
    <TextField value={password} onChange={(e)=>setPassword(e.target.value)} fullWidth type="password" label="Password" sx={{ mb: 2 }} />
    <TextField value={fullName} onChange={(e)=>setFullName(e.target.value)} fullWidth  label="Name LastName" sx={{ mb: 2 }} />
